    ...
    <div className="bg-gradient-to-br from-[#1a0f2e] to-[#140a24] rounded-2xl p-4 border border-[#2A2448] shadow-lg mb-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="  ">
            <img className="w-[60px] h-[60px] object-cover rounded-2xl" src={image} alt="" />
          </div>
...
<div>
    ...
    <Link to={'/dashboard/shifts/details'}>    <button className="bg-gradient-to-r from-purple-600 to-purple-400 text-white px-5 py-2 rounded-full text-sm font-medium hover:opacity-90 transition">
          View Details →
        </button></Link>
      </div>
    </div>
...
const Dashboard = () => {
  return (
    <div className="min-h-screen bg-[#0b0618] p-3">
      ...
      <div className="flex justify-between items-center mt-8 mb-4">
        <h2 className="text-white text-lg">Upcoming Shifts</h2>
      ...
      {/* Requests */}
      <div className="flex justify-between items-center mt-8 mb-4">
        <h2 className="text-white text-lg">Shift Requests</h2>
        <span className="text-[#3D8BFF] text-sm cursor-pointer">View All</span>
      </div>
